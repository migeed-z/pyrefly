...
class ModelArgsDict(TypedDict, total=False):
...
transformer_configs: dict[str, ModelArgsDict] = {
...
def apply_rope_scaling(freqs: torch.Tensor, rope_scaling: RopeScalingDict):
